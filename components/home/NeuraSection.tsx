    ...
    <section ref={ref} id="neura" className="relative w-full px-4 md:px-0 mt-12 md:mt-24 mb-10 h-auto md:h-[480px] flex flex-col items-center justify-center overflow-visible font-['Montserrat',sans-serif]">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full max-w-[900px] h-full mt-6 md:mt-10">
        ...
        <Card
          ...
          padding="sm"
          hoverable
          className="md:absolute md:left-[0%] lg:left-[4%] md:top-[30%] bg-white/80 backdrop-blur-xl rounded-[18px] w-[230px] md:w-[240px] shadow-[0_8px_32px_rgba(0,0,0,0.06)] z-30 border border-white/50 hover:shadow-[0_16px_48px_rgba(103,44,185,0.12)] mt-[-20px] md:mt-0 relative overflow-hidden group"
        >
          ...
          <div className="relative z-10 flex flex-col items-start text-left">
            <h3 className="text-[18px] md:text-[20px] font-bold text-gray-900 tracking-tight leading-tight">Bingung?</h3>
            <p className="mt-1.5 text-[13px] md:text-[14px] leading-[1.5] font-medium text-gray-500">
