   ...
   return (
      <div className="bg-white min-h-screen text-black font-['Montserrat',sans-serif] overflow-x-hidden flex flex-col items-center">
            ...
            >
               <div className="flex items-center justify-between px-4 md:px-6 py-3 w-full">
                  ...
                  <div className="hidden md:flex items-center gap-6 lg:gap-8 font-medium text-[13px] md:text-[14px]">
                     <Link onClick={handleScroll} href="#beranda" className={`font-bold transition-colors duration-300 ${activeSection === 'beranda' ? 'text-[#672cb9]' : 'text-gray-800 hover:text-[#672cb9]'}`}>Beranda</Link>
                     <Link onClick={handleScroll} href="#tentang" className={`font-bold transition-colors duration-300 ${activeSection === 'tentang' ? 'text-[#672cb9]' : 'text-gray-800 hover:text-[#672cb9]'}`}>Tentang Kami</Link>
                     <Link onClick={handleScroll} href="#neura" className={`font-bold transition-colors duration-300 ${activeSection === 'neura' ? 'text-[#672cb9]' : 'text-gray-800 hover:text-[#672cb9]'}`}>Neura AI</Link>
                     <Link onClick={handleScroll} href="#fitur" className={`font-bold transition-colors duration-300 ${activeSection === 'fitur' ? 'text-[#672cb9]' : 'text-gray-800 hover:text-[#672cb9]'}`}>Fitur</Link>
                     <Link onClick={handleScroll} href="#comment" className={`font-bold transition-colors duration-300 ${activeSection === 'comment' ? 'text-[#672cb9]' : 'text-gray-800 hover:text-[#672cb9]'}`}>Comment</Link>
                  </div>
                     ...
                     {user ? (
                        <div className="flex items-center gap-3 md:gap-4">
                           <Link href="/dashboard" className="hidden md:flex items-center justify-center bg-gray-900 hover:bg-black text-white px-5 py-2.5 rounded-full font-medium text-[12px] md:text-[13px] transition-transform hover:scale-105 shadow-md group">
                              Go to Dashboard
                              <span className="ml-2 inline-block transition-transform group-hover:translate-x-1">ðŸ‘‰</span>
                           </Link>
                           <Link href="/dashboard" className="md:hidden flex items-center justify-center bg-gray-900 text-white px-4 py-2 rounded-full font-medium text-[11px] shadow-md group">
                              Dashboard <span className="ml-1 inline-block transition-transform group-hover:translate-x-1">ðŸ‘‰</span>
                           </Link>
                           {user.picture ? (
               ...
               >
                  <div className="flex flex-col items-center gap-4 px-4 pb-6 pt-2 border-t border-gray-200/50">
                     <Link onClick={handleScroll} href="#beranda" className={`font-bold text-[14px] transition-colors duration-300 ${activeSection === 'beranda' ? 'text-[#672cb9]' : 'text-gray-800 hover:text-[#672cb9]'}`}>Beranda</Link>
                     <Link onClick={handleScroll} href="#tentang" className={`font-bold text-[14px] transition-colors duration-300 ${activeSection === 'tentang' ? 'text-[#672cb9]' : 'text-gray-800 hover:text-[#672cb9]'}`}>Tentang Kami</Link>
                     <Link onClick={handleScroll} href="#neura" className={`font-bold text-[14px] transition-colors duration-300 ${activeSection === 'neura' ? 'text-[#672cb9]' : 'text-gray-800 hover:text-[#672cb9]'}`}>Neura AI</Link>
                     <Link onClick={handleScroll} href="#fitur" className={`font-bold text-[14px] transition-colors duration-300 ${activeSection === 'fitur' ? 'text-[#672cb9]' : 'text-gray-800 hover:text-[#672cb9]'}`}>Fitur</Link>
                     <Link onClick={handleScroll} href="#comment" className={`font-bold text-[14px] transition-colors duration-300 ${activeSection === 'comment' ? 'text-[#672cb9]' : 'text-gray-800 hover:text-[#672cb9]'}`}>Comment</Link>
         ...
         <main id="beranda" className="w-full flex flex-col items-center max-w-[1440px] relative mt-20 md:mt-22">
               ...
               <AuroraBackground className="w-full rounded-[24px] md:rounded-[36px] overflow-hidden pt-10 pb-12 md:pt-[54px] md:pb-[54px] px-6 md:px-12 lg:px-16 flex flex-col md:flex-row items-center md:items-start gap-10 md:gap-0 min-h-[460px] md:min-h-[480px]">
                  ...
                  <div className="flex flex-col items-center md:items-start z-30 w-full md:w-[45%] text-center md:text-left mt-0 md:mt-2">
                     ...
                     <p className="font-['Montserrat',sans-serif] text-[13px] md:text-[15px] lg:text-[16px] leading-[1.6] text-white/95 mt-6 md:mt-8 z-10 w-full max-w-[310px] md:max-w-[440px] font-medium">
                        Upload PDF, Audio, atau link YouTube â€” AI akan meringkasnya menjadi materi yang siap dipelajari lebih cepat.
                     </p>
            ...
            {/* Tentang Section â€” Sleek & Premium Bento Box */}
            <section id="tentang" className="relative w-full px-6 md:px-12 lg:px-24 py-24 md:py-32 bg-[#fcfcfc] flex flex-col items-center overflow-hidden">
               ...
               <div className="flex flex-col items-center text-center mb-16 md:mb-24 z-10 w-full max-w-[800px]">
                  ...
                  >
                     Era Baru Belajar Cerdas dengan <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#672cb9] to-[#8c46d4]">Kekuatan AI Multimodal.</span>
                  </motion.h2>
               ...
               {/* Bento Grid Layout - High-End Corporate/SaaS Style */}
               <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-5 w-full max-w-[1240px] z-10 relative">
                  ...
                  >
                     <div className="w-10 h-10 rounded-full bg-orange-50 flex items-center justify-center mb-6 text-[#ffa515] border border-orange-100/50">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" /></svg>
                     </div>
                  ...
                  >
                     <div className="w-16 h-16 shrink-0 rounded-[18px] bg-[#fafafa] border border-gray-100 shadow-[0_2px_8px_rgba(0,0,0,0.02)] flex items-center justify-center text-gray-700">
                        <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polygon points="12 2 2 7 12 12 22 7 12 2" /><polyline points="2 17 12 22 22 17" /><polyline points="2 12 12 17 22 12" /></svg>
                     </div>
                     <div>
                        <h3 className="text-[18px] font-bold text-gray-900 mb-2 tracking-tight">Teknologi yang Teruji</h3>
                        <p className="text-[14px] leading-[1.6] text-gray-500 font-medium">Keunggulan utama OtakEncer terletak pada arsitektur AI-nya yang mampu mengenali struktur logika dalam teks dan audio secara presisi, menjadikannya standar baru dalam alat bantu belajar akademik.</p>
                     </div>
                  </motion.div>

                  {/* Dark Mode Reliability Block */}
                  <motion.div
                     initial={{ opacity: 0, y: 30 }}
                     whileInView={{ opacity: 1, y: 0 }}
                     viewport={{ once: true }}
                  ...
                  >
                     {/* Elegant Grid Lines */}
                     <div className="absolute inset-0" style={{ backgroundImage: 'linear-gradient(rgba(255, 255, 255, 0.035) 1px, transparent 1px), linear-gradient(90deg, rgba(255, 255, 255, 0.035) 1px, transparent 1px)', backgroundSize: '32px 32px' }}></div>
                     ...
                     <div className="relative h-full p-8 md:p-10 flex flex-col justify-center z-10">
                        ...
                        <div className="w-full lg:w-[85%]">
                           ...
                           <p className="text-[14px] leading-[1.6] text-white/50 font-medium">Bekerja tanpa henti untuk memastikan data dan proses riset Anda aman, sinkron, dan selalu dapat diakses kapan pun inspirasi datang.</p>
                        </div>
                     </div>
                  </motion.div>
            ...
            {/* Neura Block Section */}
            <section ref={neuraRef} id="neura" className="relative w-full px-4 md:px-0 mt-12 md:mt-24 mb-10 h-auto md:h-[480px] flex flex-col items-center justify-center overflow-visible">
               ...
               <div className="relative z-10 flex flex-col items-center justify-center w-full max-w-[900px] h-full mt-6 md:mt-10">
                  ...
                  {/* Center Mascot â€” Adjusted size for proportion */}
                  <motion.div
                     animate={{ y: [0, -10, 0] }}
                  ...
                  {/* Left Card â€” Sleek Minimal Professional Card */}
                  <motion.div
                     initial={{ opacity: 0, y: 20 }}
                     whileInView={{ opacity: 1, y: 0 }}
                     viewport={{ once: true }}
                  ...
                  >
                     ...
                     <div className="relative z-10 flex flex-col items-start text-left">
                        <h3 className="font-['Montserrat',sans-serif] text-[18px] md:text-[20px] font-bold text-gray-900 tracking-tight leading-tight">
                           Bingung?
                        </h3>
                     ...
                     <div className="mt-4 w-7 h-7 rounded-full border border-gray-100 flex items-center justify-center bg-gray-50 group-hover:bg-[#672cb9] transition-colors duration-300">
                        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-gray-400 group-hover:text-white transition-colors duration-300 transform group-hover:translate-x-0.5"><path d="M5 12h14" /><path d="m12 5 7 7-7 7" /></svg>
                     </div>
                  </motion.div>
