      ...
      <div className="relative flex flex-col items-center text-center max-w-[700px] w-full z-10">
        ...
        <div className="relative w-full flex justify-center mb-6">
          ...
          <motion.div 
            ...
            className="relative z-10 w-[260px] h-[260px] sm:w-[280px] sm:h-[280px] md:w-[320px] md:h-[320px] filter drop-shadow-[0_15px_30px_rgba(103,44,185,0.15)] mt-4"
          >
            <Image 
        ...
        <motion.div
           ...
           className="relative z-20 flex flex-col items-center px-4 w-full"
        >
           <h2 className="text-[20px] sm:text-[22px] md:text-[28px] font-bold text-[#1e293b] mb-2 tracking-tight text-center">
             Waduh! Halaman Hilang...
           </h2>
           <p className="text-gray-600 text-[13px] sm:text-[14px] md:text-[15px] font-medium leading-relaxed mb-8 max-w-[420px] mx-auto text-center">
           ...
           >
              <Link 
                href="/dashboard" 
                className="inline-flex justify-center w-auto items-center gap-2 px-8 py-3.5 bg-gradient-to-r from-[#7c3aed] to-[#6d28d9] text-white font-semibold text-[14px] sm:text-[15px] rounded-full shadow-[0_8px_20px_rgba(124,58,237,0.25)] hover:shadow-[0_12px_25px_rgba(124,58,237,0.35)] transition-all"
              >
